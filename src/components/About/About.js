				...
				<Fade duration={500}>
					...
					<div className="container my-5">
						<h2 className="text-center">
							<a href="https://github.com/its-vikash/">15x30 DSA Cracker</a> is your personal web-based progress tracker based on <br></br>
							<i>
								<a
						...
						<h4 className="text-center my-5">
							Project by{" "}
							<a href="https://www.linkedin.com/in/its-vikash/" target="_blank" rel="noopener noreferrer">
								Vikash Patel
							</a>{" "}
